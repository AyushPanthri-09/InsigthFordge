...
/* ── Tech stack data ───────────────────────────────────────── */
const TECH_STACK = [
  { name: "Firebase", color: "oklch(0.78 0.18 55)", glow: "oklch(0.78 0.18 55 / 20%)" },
  { name: "Python", color: "oklch(0.75 0.15 230)", glow: "oklch(0.75 0.15 230 / 18%)" },
  { name: "Pandas", color: "oklch(0.70 0.14 250)", glow: "oklch(0.70 0.14 250 / 18%)" },
  { name: "Scikit-learn", color: "oklch(0.72 0.18 155)", glow: "oklch(0.72 0.18 155 / 18%)" },
];
